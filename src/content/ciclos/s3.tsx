    ...
    conteudo: [
      {
        ...
        porque:
          "Critério definido depois tende a justificar a ideia de quem fala mais alto.",
      },
      {
        decisao:
          "Aderência ao órgão público entra como critério com peso próprio.",
        porque:
  ...
  responsaveis: {
    ...
    conteudo: [
      ...
      },
      {
        integrante: "rafael",
        contribuicao:
          "Avaliou quais alternativas geram dado aproveitável por modelo.",
      },
      {
        integrante: "fernando",
        contribuicao:
          "Registrou a dinâmica e consolidou a justificativa da escolha.",
      },
    ],
  },
...
export const documentos = [
  {
    ...
    resumo:
      "brainwriting, brainstorming e crazy 8’s, com tempo e produto de cada.",
    Conteudo: () => (
      <>
        <Grade colunas={3}>
          <Cartao titulo="Brainwriting" etiqueta="20 min">
            <p>
              Cada integrante escreve três ideias em silêncio, sem discutir, e
              passa a folha adiante. Quem recebe amplia a ideia do colega em vez
              de criticá-la.
            </p>
            <p>
              <strong>Produto:</strong> 18 ideias escritas, sem viés de quem
              fala primeiro.
            </p>
          </Cartao>
          <Cartao titulo="Brainstorming" etiqueta="25 min">
            <p>
              Discussão aberta a partir das folhas do brainwriting, agrupando
              ideias parecidas e nomeando os grupos.
            </p>
            <p>
              <strong>Produto:</strong> de 6 a 8 alternativas distintas, já
              agrupadas.
            </p>
          </Cartao>
          <Cartao titulo="Crazy 8’s" etiqueta="8 min">
            <p>
              Oito esboços de tela em oito minutos, individualmente, para as
              duas alternativas mais votadas.
            </p>
            <p>
              <strong>Produto:</strong> primeiras telas em papel, insumo do
              protótipo.
            </p>
          </Cartao>
        </Grade>
      ...
      <>
        <Tabela
          ...
          linhas={[
            ...
            [
              "Formulário de coleta + planilha de consolidação",
              "2",
              "2",
              "4",
              "Descartada",
            ...
            [
              "Painel de indicadores sem cálculo de gratificação",
              "2",
              "3",
              "3",
              "Descartada",
            ...
            [
              "Robô que lê as planilhas e consolida sozinho",
              "3",
              "4",
              "2",
              "Descartada",
            ...
            [
              "Módulo dentro de um ERP público existente",
              "4",
              "5",
              "2",
              "Descartada",
            ...
            [
              "Aplicativo mobile para o gestor avaliado",
              "2",
              "3",
              "2",
              "Adiada",
            ...
            [
              "Modelo preditivo de risco de não-atingimento",
              "3",
              "3",
              "4",
              "Incorporada",
  ...
  },
  {
    ...
    Conteudo: () => (
      <>
        ...
        <div className="mt-3">
          <Nota>
            A alternativa “melhorar a planilha” continua na matriz de propósito:
            ela é a régua contra a qual o ganho do sistema é medido na validação
            da Semana 11.
          </Nota>
        </div>
      </>

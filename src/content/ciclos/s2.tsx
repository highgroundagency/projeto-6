  ...
  responsaveis: {
    ...
    conteudo: [
      ...
      },
      {
        ...
        contribuicao:
          "Modelou o processo atual como fluxo, do lançamento à homologação.",
      },
      {
      ...
      },
      {
        integrante: "rafael",
        contribuicao:
          "Mapeou quais perguntas do problema são respondíveis por modelo.",
      },
    ],
  },
...
export const documentos = [
  ...
  },
  {
    ...
    resumo:
      "três personagens fictícios e o mapa da analista que carrega o processo.",
    Conteudo: () => (
      <>
        <Secao
          titulo="Personas"
        ...
        >
          <Grade colunas={3}>
            <Cartao titulo="Analista da CAM" etiqueta="Primária">
              <p>
                Opera a planilha mestre há três ciclos. Conhece as regras de cor
                e é procurada sempre que alguém contesta um resultado.
              </p>
              <p>
                <strong>Precisa:</strong> fechar o ciclo sem medo de ter errado
                uma fórmula.
              </p>
              <p>
            ...
            <Cartao titulo="Gestor de área técnica" etiqueta="Secundária">
              <p>
                Responde por informar de 4 a 8 indicadores da própria área,
                sempre em cima do prazo, entre outras dez prioridades.
              </p>
              <p>
                <strong>Precisa:</strong> saber exatamente o que informar e até
                quando.
              </p>
              <p>
                <strong>Teme:</strong> ser cobrado por um dado que ele já
                enviou.
              </p>
            </Cartao>
            <Cartao titulo="Coordenadora avaliada" etiqueta="Secundária">
              <p>
                Recebe a gratificação variável e vê apenas o resultado final,
                sem o caminho que levou até ele.
              </p>
              <p>
                <strong>Precisa:</strong> entender por que o valor foi aquele.
              </p>
              <p>
                <strong>Teme:</strong> ser avaliada por dado que ela não pôde
                conferir.
              </p>
            </Cartao>
          </Grade>
  ...
  },
  {
    ...
    Conteudo: () => (
      <>
        ...
        <div className="mt-3">
          <Nota>
            Conclusão do benchmarking: nenhuma ferramenta pronta cobre a
            combinação “regra normativa versionada + memória de cálculo + trilha
            de auditoria”. Ela é o núcleo do problema — e é por isso que a
            decisão foi construir.
          </Nota>
        </div>
      </>
    ),

...
export const registro = {
  ...
  decisoes: {
    ...
    conteudo: [
      ...
      {
        decisao: 'Indicadores e regras serão parametrizáveis pela interface, não escritos em código.',
        porque:
  ...
  responsaveis: {
    ...
    conteudo: [
      ...
      { integrante: 'fernando', contribuicao: 'Fez o benchmarking e o recorte de LGPD do problema.' },
      { integrante: 'joao-henrique', contribuicao: 'Modelou o processo atual como fluxo, do lançamento à homologação.' },
      { integrante: 'joao-pedro', contribuicao: 'Traduziu as personas em necessidades de interface.' },
      { integrante: 'rafael', contribuicao: 'Mapeou quais perguntas do problema são respondíveis por modelo.' },
    ],
  },
  ...
  return (
    <>
      <Secao
        ...
        descricao="Como a gratificação é calculada antes do Prumo existir."
      >
        <Tabela
      ...
      >
        <Grade colunas={3}>
          <Cartao titulo="Analista da CAM" etiqueta="Primária">
            <p>
              Opera a planilha mestre há três ciclos. Conhece as regras de cor e é
              procurada sempre que alguém contesta um resultado.
            </p>
            <p>
          ...
          <Cartao titulo="Gestor de área técnica" etiqueta="Secundária">
            <p>
              Responde por informar de 4 a 8 indicadores da própria área, sempre em cima
              do prazo, entre outras dez prioridades.
            </p>
            <p>
          ...
          <Cartao titulo="Coordenadora avaliada" etiqueta="Secundária">
            <p>
              Recebe a gratificação variável e vê apenas o resultado final, sem o caminho
              que levou até ele.
            </p>
            <p>
      ...
      <Secao titulo="Benchmarking">
        ...
        <div className="mt-3">
          <Nota>
            Conclusão do benchmarking: nenhuma ferramenta pronta cobre a combinação
            “regra normativa versionada + memória de cálculo + trilha de auditoria”. Ela é
            o núcleo do problema — e é por isso que a decisão foi construir.
          </Nota>
        </div>
      </Secao>

import { Lista, Nota, Tabela } from "@/components/conteudo";
...
export const registro = {
  ...
  decisoes: {
    ...
    conteudo: [
      {
        decisao:
          "Mostrar a memória de cálculo ao vivo em vez de descrevê-la em slide.",
        porque:
  ...
  bloqueios: {
    ...
    validadoPor: "fernando",
    conteudo: [
      "Ensaio cronometrado com os seis integrantes ainda não realizado.",
    ],
  },
  ...
  responsaveis: {
    ...
    conteudo: [
      {
        integrante: "gabriel",
        contribuicao: "Abertura: problema e contexto do cliente.",
      },
      {
        integrante: "matheus",
        contribuicao: "Relevância: quem sofre e o que a pesquisa mostrou.",
      },
      {
        integrante: "joao-henrique",
        contribuicao: "Causa raiz: por que a planilha não escala.",
      },
      {
        integrante: "joao-pedro",
        contribuicao:
          "Demonstração da ideia priorizada e da memória de cálculo.",
      },
      {
        integrante: "rafael",
        contribuicao: "Onde entram os modelos e o que eles respondem.",
      },
      {
        integrante: "fernando",
        contribuicao: "Governança, privacidade e direcionamento até o SR1.",
      },
    ],
  },
...
export const documentos = [
  ...
  {
    id: "slides",
    titulo: "Estrutura de slides",
    resumo: "a sequência de telas do pitch.",
    Conteudo: () => (
      <>
        <Lista
          itens={[
  ...
  },
  {
    ...
    resumo: "o que esperamos ouvir e a resposta preparada.",
    Conteudo: () => (
      <>
        <Lista
          itens={[

  ...
  responsaveis: {
    ...
    conteudo: [
      ...
      },
      {
        ...
        contribuicao:
          "Delimitou o escopo técnico e as fronteiras de integração.",
      },
      {
      ...
      },
      {
        integrante: "fernando",
        contribuicao:
          "Revisou o escopo sob a ótica de segurança e privacidade.",
      },
    ],
  },
      ...
      <>
        <Tabela
          ...
          linhas={[
            ...
            [
              "Ciclo",
              "Como CAM, quero homologar o ciclo para congelar os resultados",
              "M",
            ],
            [
              "Ciclo",

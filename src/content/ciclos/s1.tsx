...
export const registro = {
  ...
  responsaveis: {
    ...
    conteudo: [
      ...
      { integrante: 'joao-henrique', contribuicao: 'Definiu a stack e abriu o repositório.' },
      { integrante: 'joao-pedro', contribuicao: 'Propôs a identidade visual e o nome do produto.' },
      { integrante: 'rafael', contribuicao: 'Mapeou onde o módulo de ML entra no problema.' },
      { integrante: 'fernando', contribuicao: 'Montou a estrutura de documentação e o registro de uso de IA.' },
    ],
  },
  ...
  return (
    <>
      <Secao
        ...
        descricao="Três critérios foram usados para escolher entre as opções que a equipe levantou."
      >
        <Lista
          itens={[
      ...
      <Secao titulo="O que já sabemos do problema">

...
/**
 * Meu resultado — rota histórica, hoje um redirecionamento (ADR-023).
 *
...
export default async function RotaMeuResultado() {
  await exigirPerfil('meu-resultado')
  redirect(`/sistema?abrir=meu-resultado${ancoraDaTela('meu-resultado')}`)
}

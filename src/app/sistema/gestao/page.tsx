...
/**
 * Painel da gestão — rota histórica, hoje um redirecionamento (ADR-023).
 *
...
export default async function RotaGestao() {
  await exigirPerfil('painel-gestao')
  redirect(`/sistema?abrir=painel-gestao${ancoraDaTela('painel-gestao')}`)
}

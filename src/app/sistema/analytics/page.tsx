...
/**
 * Analytics — rota histórica, hoje um redirecionamento (ADR-023).
 *
...
export default async function RotaAnalytics() {
  await exigirPerfil('analytics')
  redirect(`/sistema?abrir=analytics${ancoraDaTela('analytics')}`)
}

...
/**
 * Indicadores e regras — rota histórica, hoje um redirecionamento (ADR-023).
 *
...
export default async function RotaIndicadores() {
  await exigirPerfil('indicadores')
  redirect(`/sistema?abrir=indicadores${ancoraDaTela('indicadores')}`)
}

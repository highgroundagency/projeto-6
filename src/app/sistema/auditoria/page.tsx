...
/**
 * Auditoria — rota histórica, hoje um redirecionamento (ADR-023).
 *
...
export default async function RotaAuditoria() {
  await exigirPerfil('auditoria')
  redirect(`/sistema?abrir=auditoria${ancoraDaTela('auditoria')}`)
}

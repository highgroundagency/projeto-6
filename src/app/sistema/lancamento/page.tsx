...
/**
 * Lançamento — rota histórica, hoje um redirecionamento (ADR-023).
 *
...
export default async function RotaLancamento() {
  await exigirPerfil('lancamento')
  redirect(`/sistema?abrir=lancamento${ancoraDaTela('lancamento')}`)
}

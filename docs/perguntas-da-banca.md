...
Com teste. Em 25/09 eram 55 testes automáticos só no motor: fronteira de faixa, arredondamento, pesos diferentes, nota perfeita fechando em 100 e o método de notas da versão 3. No projeto inteiro, eram 602 testes de unidade passando. Outro teste confere que o motor não lê relógio, não sorteia e não abre arquivo nem rede (`src/lib/pureza.test.ts`). O que falta é conferir o motor contra linhas reais da planilha da Secretaria, que prometemos para o SR1.
